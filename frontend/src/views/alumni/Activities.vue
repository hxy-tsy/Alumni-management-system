...
<template>
  <div class="greetings">
    ...
    <el-dialog
      ...
      width="500px"
    >
      <el-form :model="greetingForm" :rules="rules" ref="greetingFormRef" label-width="100px" disabled>
        <el-form-item label="标题" prop="title">
          <el-input v-model="greetingForm.title" disabled/>
        </el-form-item>
        <el-form-item label="内容" prop="content">
          <el-input v-model="greetingForm.content" type="textarea" :rows="4" disabled/>
        </el-form-item>
        <el-form-item label="短信类型" prop="type">
          <el-select v-model="greetingForm.type" placeholder="请选择短信类型" disabled>
            <el-option label="新闻通知" value="news" />
            <el-option label="活动通知" value="activity" />
            <el-option label="节日祝福" value="greeting" />
          </el-select>
        </el-form-item>
        <el-form-item label="接收者" prop="receivers" disabled="true">
